...
GeneExp_Medium3 <- GeneExp[,GeneExp[Target_gene_name,] < Target_gene_Mean+(Target_gene_SD/5) & GeneExp[Target_gene_name,] > Target_gene_Mean-(Target_gene_SD/5)]
